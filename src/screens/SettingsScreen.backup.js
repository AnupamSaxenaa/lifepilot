...
import { loadProfile, updateProfile, deleteUserAccountData } from '../lib/dataManager';
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 16, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: '#1A1A1C',
    backgroundColor: '#000000'
  },
  iconButton: { padding: 8 },
  headerTitle: { color: THEME_COLOR, fontSize: 17, fontWeight: '600' },
  scroll: { paddingBottom: 40 },

  // Profile Header
  profileHeader: { alignItems: 'center', marginTop: 32, marginBottom: 40 },
  avatarWrap: { position: 'relative', marginBottom: 16 },
  avatar: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#1C1C1E', borderWidth: 1, borderColor: '#333' },
  cameraBadge: {
    position: 'absolute', bottom: 0, right: 0, width: 32, height: 32, borderRadius: 16,
    backgroundColor: '#3B82F6', alignItems: 'center', justifyContent: 'center',
    borderWidth: 2, borderColor: '#000',
  },
  profileName: { color: THEME_COLOR, fontSize: 24, fontWeight: '700', marginBottom: 4 },
  profileUsername: { color: '#888', fontSize: 15, fontWeight: '500', marginBottom: 2 },
  profileEmail: { color: '#555', fontSize: 14, fontWeight: '400' },

  // Sections
  sectionTitle: { color: '#666', fontSize: 12, fontWeight: '600', letterSpacing: 0.8, marginBottom: 8, marginLeft: 28, textTransform: 'uppercase' },
  settingGroup: { backgroundColor: '#161618', borderRadius: 16, marginHorizontal: 16, marginBottom: 32 },
  
  // Setting Rows
  settingRow: { flexDirection: 'row', alignItems: 'center', paddingTop: 14, paddingBottom: 14, paddingRight: 16, paddingLeft: 12 },
  settingIconWrap: { width: 32, height: 32, borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  settingInfo: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  settingLabel: { color: '#FFF', fontSize: 16, fontWeight: '500' },
  settingValue: { color: '#888', fontSize: 15, fontWeight: '400', marginRight: 8 },
  divider: { height: StyleSheet.hairlineWidth, backgroundColor: '#2C2C2E', marginLeft: 58 },

  // Avatar Options
  avatarOption: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 4 },

  // Modal
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' },
  modalContent: {
    backgroundColor: '#161618', borderTopLeftRadius: 24, borderTopRightRadius: 24,
  ...
  modalCloseIcon: { backgroundColor: '#2A2A2C', padding: 6, borderRadius: 16 },
  modalHint: { color: '#888', fontSize: 13, fontWeight: '400', marginBottom: 12 },
  modalInput: {
    backgroundColor: '#000000', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 16,
    color: '#fff', fontSize: 16, borderWidth: 1, borderColor: '#2A2A2C',
  },
  modalBtn: { alignItems: 'center', paddingVertical: 16, borderRadius: 14, marginTop: 20, backgroundColor: '#FFFFFF' },
  modalBtnText: { color: '#000', fontSize: 16, fontWeight: '700' },
  formError: { color: '#EF4444', fontSize: 13, fontWeight: '500', marginTop: 8 },

  // Username
  usernameInputRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#000000', borderRadius: 12, borderWidth: 1, borderColor: '#2A2A2C', paddingLeft: 16 },
  usernamePrefix: { color: '#888', fontSize: 18, fontWeight: '500' },

  // OTP / Password
  otpHint: { color: '#666', fontSize: 12, fontWeight: '400', textAlign: 'center', marginTop: 16 },
  otpSentBanner: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#10B98115', padding: 14, borderRadius: 12 },
  otpSentText: { color: '#10B981', fontSize: 14, fontWeight: '500', flex: 1 },
  otpInput: { fontSize: 28, fontWeight: '700', letterSpacing: 16, paddingVertical: 20, paddingLeft: 24 },
  resendBtn: { alignItems: 'center', marginTop: 20 },
  resendText: { color: '#888', fontSize: 14, fontWeight: '500' },

  // Delete
  deleteWarning: { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: '#EF444415', padding: 16, borderRadius: 12, marginBottom: 20 },
  deleteWarningText: { flex: 1, color: '#EF4444', fontSize: 13, fontWeight: '500', lineHeight: 20 },
});
